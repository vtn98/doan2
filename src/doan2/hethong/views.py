...
def them_ncc(request):
	return render(request, 'hethong/them_ncc.html')

def danh_sach_ncc(request):
	return render(request, 'hethong/header.html')
...
def header(request):
	return render(request, 'hethong/chuyen_kho.html')
...
def thong_ke_kho_hang(request, idkhohang):
	return render(request, 'hethong/thong_ke_kho_hang.html')
